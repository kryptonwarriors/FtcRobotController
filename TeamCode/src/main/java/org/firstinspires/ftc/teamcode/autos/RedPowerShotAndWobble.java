...
@Autonomous(name = "RedPowerShotAndWobble", group = "autos")
public class RedPowerShotAndWobble extends LinearOpMode {
    ...
    public static int xPos1 = 502;
    public static int yPos1 = 323;
...
//GO TO TARGET ZONE
            ...
            if(position == 3){
                ...
                moveEncoders(LEFT, 0.7, 700, 0);

            } else if(position == 2){
                moveEncoders(BACKWARD, 0.7, 600, getAngle());
